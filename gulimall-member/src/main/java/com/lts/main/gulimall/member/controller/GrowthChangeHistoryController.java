package com.lts.main.gulimall.member.controller;

import java.util.Arrays;
import java.util.Map;

import com.lts.main.gulimall.member.entity.MemberEntity;
import com.lts.main.gulimall.member.fegin.CouponFeginServer;
...
import com.lts.main.gulimall.member.service.GrowthChangeHistoryService;
...
public class GrowthChangeHistoryController {
    ...
    @Autowired
    private CouponFeginServer couponFeginServer;
    ...
    public R test(){
        ...
        R membercoupons=couponFeginServer.membercoupons();
